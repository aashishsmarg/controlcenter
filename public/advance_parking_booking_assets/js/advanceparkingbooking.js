...
function mobilecheck() {
  ...
  if (mobile.length == 0) {
    err1.innerHTML = "Please Enter Mobile Number"
    err1.style.color = "red"
  } else if (isNaN(mobile)) {
    err1.innerHTML = "Please Enter Only Number"
    err1.style.color = "red"
  } else if (mobile.length < 10 || mobile.length > 10) {
    err1.innerHTML = "Please Enter Valid Mobile Number"
    err1.style.color = "red"
  } else {
    err1.innerHTML = ""
  }
...
function vehiclenumber_check() {
  ...
  if (veh_num_result.length == 0) {
    err2.innerHTML = "Please Enter Vehicle Number";
    err2.style.color = "red"
  } else if (veh_num_result) {
    err2.innerHTML = "";
  } else {
    err2.innerHTML = "Please Enter Valid Vehicle Number";
    err2.style.color = "red"
  }
}
...
$(function () {
  ...
  setTimeout(function () { $('#mainsuccessMessage').hide(); }, duration);
});
